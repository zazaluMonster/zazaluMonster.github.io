...
## 基本信息
我叫何镓钧，来自浙江绍兴，17年毕业于西安电子科技大学软件学院。

## 聊聊黄河银行项目

（从项目的简单介绍说起）
我毕业后就一直从事银行相关业务系统的开发，比如我在黄河银行参与了其一码付平台二期的开发与维护，一码付平台是福建联迪（我当时就职的公司），为黄河银行提供的一套聚合支付交易平台，聚合各类第三方支付服务比如支付宝微信（所谓的一码是指一个二维码就可以向客户提供各类第三方支付服务，比如支付宝，微信支付，银闪付等等）。同时呢一码付平台还提供了面向行内用户的管理平台和面向商户的商户服务平台。每个平台都支持ios，android，和web端进行操作
...
（目的是表现我的沟通能力以及做事的主动性）
最后再来说说我的驻场开发，驻场开发阶段，我作为公司唯一的Java驻场开发人员，需要对接银行核心接口，与银行核心的开发人员讨论数据接口；需要对接IOS和Android的数据接口，保证数据接口准确无误；参与项目相关的各类大小会议，并常常发言说出自己的观点；所以我认为我拥有良好的沟通能力和工作主动性，以实现自我价值为目标，为项目贡献自己的一份力